...
BUILDFILE = 'https://lusd1.org/kodi/builds/build-addons/builds.txt'
...
REPOID = 'repository.lusd'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://sweetkitten27.github.io/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://sweetkitten27.github.io/repo/repository.lusd-1.1.0.zip'
#########################################################
