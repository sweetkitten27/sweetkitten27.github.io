...
subPath = translatePath('special://profile/addon_data/script.ivueguide/resources/ini')
pyPath = translatePath('special://profile/addon_data/script.ivueguide/resources/subs')
setupPath = translatePath('special://profile/addon_data/script.ivueguide/resources/guide_setups')
fullPath = translatePath('special://profile/addon_data/script.ivueguide')
...
def refreshchannames(silent=False):
	conn = sqlite3.connect(translatePath("special://home/userdata/addon_data/script.ivueguide/master.db"))
	try:
		with conn:
