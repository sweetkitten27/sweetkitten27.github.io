...
root_xml_url = base64.b64decode("aHR0cHM6Ly9tYWduZXRpYy53ZWJzaXRlL01BRF9USVRBTl9TUE9SVFMxL21hZF90aXRhbi5qc29u").decode("utf-8")

# root_xml_url ="file://FRONT/MAIN.json"
plugin = DI.plugin
short_checker = ([
    'Adf.ly', 
    'Bit.ly', 
